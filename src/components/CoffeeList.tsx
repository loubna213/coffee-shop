...
const CoffeeList = () => {
    ...
    return (
        <section className='max-container relative mt-[-10rem] max-md:mt-[-3rem] rounded-lg bg-dark-200 h-full w-4/5 max-md:w-[90%] flex flex-col justify-center items-center px-6 py-20'>
